...
static void mavlink_test_set_control_gains(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SET_CONTROL_GAINS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_set_control_gains_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0
    };
    mavlink_set_control_gains_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.pos_pgain = packet_in.pos_pgain;
        packet1.pos_pgain_z = packet_in.pos_pgain_z;
        packet1.vel_pgain = packet_in.vel_pgain;
        packet1.vel_igain = packet_in.vel_igain;
        packet1.vel_pgain_z = packet_in.vel_pgain_z;
        packet1.vel_igain_z = packet_in.vel_igain_z;
        packet1.yaw_pgain = packet_in.yaw_pgain;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SET_CONTROL_GAINS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SET_CONTROL_GAINS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_control_gains_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_set_control_gains_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_control_gains_pack(system_id, component_id, &msg , packet1.pos_pgain , packet1.pos_pgain_z , packet1.vel_pgain , packet1.vel_igain , packet1.vel_pgain_z , packet1.vel_igain_z , packet1.yaw_pgain );
    mavlink_msg_set_control_gains_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_control_gains_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pos_pgain , packet1.pos_pgain_z , packet1.vel_pgain , packet1.vel_igain , packet1.vel_pgain_z , packet1.vel_igain_z , packet1.yaw_pgain );
    mavlink_msg_set_control_gains_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_set_control_gains_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_control_gains_send(MAVLINK_COMM_1 , packet1.pos_pgain , packet1.pos_pgain_z , packet1.vel_pgain , packet1.vel_igain , packet1.vel_pgain_z , packet1.vel_igain_z , packet1.yaw_pgain );
    mavlink_msg_set_control_gains_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("SET_CONTROL_GAINS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_SET_CONTROL_GAINS) != NULL);
#endif
}

static void mavlink_test_control_gains(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CONTROL_GAINS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_control_gains_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0
    };
    mavlink_control_gains_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.pos_pgain = packet_in.pos_pgain;
        packet1.pos_pgain_z = packet_in.pos_pgain_z;
        packet1.vel_pgain = packet_in.vel_pgain;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CONTROL_GAINS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CONTROL_GAINS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_gains_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_control_gains_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_gains_pack(system_id, component_id, &msg , packet1.pos_pgain , packet1.pos_pgain_z , packet1.vel_pgain , packet1.vel_igain , packet1.vel_pgain_z , packet1.vel_igain_z , packet1.yaw_pgain );
    mavlink_msg_control_gains_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_gains_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pos_pgain , packet1.pos_pgain_z , packet1.vel_pgain , packet1.vel_igain , packet1.vel_pgain_z , packet1.vel_igain_z , packet1.yaw_pgain );
    mavlink_msg_control_gains_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_control_gains_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_gains_send(MAVLINK_COMM_1 , packet1.pos_pgain , packet1.pos_pgain_z , packet1.vel_pgain , packet1.vel_igain , packet1.vel_pgain_z , packet1.vel_igain_z , packet1.yaw_pgain );
    mavlink_msg_control_gains_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("CONTROL_GAINS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_CONTROL_GAINS) != NULL);
#endif
}

static void mavlink_test_target_ned(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_TARGET_NED >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_target_ned_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0
    };
    mavlink_target_ned_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.north = packet_in.north;
        packet1.east = packet_in.east;
        packet1.down = packet_in.down;
        packet1.yaw = packet_in.yaw;
        packet1.angle_in_frame = packet_in.angle_in_frame;
        packet1.desired_north = packet_in.desired_north;
        packet1.desired_east = packet_in.desired_east;
        packet1.desired_down = packet_in.desired_down;
        packet1.desired_angle_in_frame = packet_in.desired_angle_in_frame;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_TARGET_NED_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_TARGET_NED_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_target_ned_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_target_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_target_ned_pack(system_id, component_id, &msg , packet1.north , packet1.east , packet1.down , packet1.yaw , packet1.angle_in_frame , packet1.desired_north , packet1.desired_east , packet1.desired_down , packet1.desired_angle_in_frame );
    mavlink_msg_target_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_target_ned_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.north , packet1.east , packet1.down , packet1.yaw , packet1.angle_in_frame , packet1.desired_north , packet1.desired_east , packet1.desired_down , packet1.desired_angle_in_frame );
    mavlink_msg_target_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_target_ned_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_target_ned_send(MAVLINK_COMM_1 , packet1.north , packet1.east , packet1.down , packet1.yaw , packet1.angle_in_frame , packet1.desired_north , packet1.desired_east , packet1.desired_down , packet1.desired_angle_in_frame );
    mavlink_msg_target_ned_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("TARGET_NED") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_TARGET_NED) != NULL);
#endif
}

static void mavlink_test_set_target_ned(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SET_TARGET_NED >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_set_target_ned_t packet_in = {
        17.0,45.0,73.0,101.0
    };
    mavlink_set_target_ned_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.desired_north = packet_in.desired_north;
        packet1.desired_east = packet_in.desired_east;
        packet1.desired_down = packet_in.desired_down;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SET_TARGET_NED_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SET_TARGET_NED_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_target_ned_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_set_target_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_target_ned_pack(system_id, component_id, &msg , packet1.desired_north , packet1.desired_east , packet1.desired_down , packet1.desired_angle_in_frame );
    mavlink_msg_set_target_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_target_ned_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.desired_north , packet1.desired_east , packet1.desired_down , packet1.desired_angle_in_frame );
    mavlink_msg_set_target_ned_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_set_target_ned_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_set_target_ned_send(MAVLINK_COMM_1 , packet1.desired_north , packet1.desired_east , packet1.desired_down , packet1.desired_angle_in_frame );
    mavlink_msg_set_target_ned_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("SET_TARGET_NED") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_SET_TARGET_NED) != NULL);
#endif
}

static void mavlink_test_control_targets(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_CONTROL_TARGETS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_control_targets_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_CONTROL_TARGETS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_CONTROL_TARGETS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_control_targets_encode(system_id, component_id, &msg, &packet1);
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("CONTROL_TARGETS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_CONTROL_TARGETS) != NULL);
#endif
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_set_control_gains(system_id, component_id, last_msg);
    mavlink_test_control_gains(system_id, component_id, last_msg);
    mavlink_test_target_ned(system_id, component_id, last_msg);
    mavlink_test_set_target_ned(system_id, component_id, last_msg);
    mavlink_test_control_targets(system_id, component_id, last_msg);
